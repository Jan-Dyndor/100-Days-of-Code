...
def calculate_score(cards):
    """Returns a sum of a elements in list"""
...
def compare(user_score, computer_score):
    """Checks who won and returns proper statementt"""
...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f"Tour cards: {user_cards}, current score: {user_score}")
    ...
    print(f"Computer final hand is {computer_cards} and final score {computer_cards}")
